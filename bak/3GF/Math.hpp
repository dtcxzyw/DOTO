...
namespace Math {
    ...
    // https://github.com/dtcxzyw/Camera/blob/master/Src/Sampler/SequenceGenerator.cu
    FT halton3(uint32_t index);
    FT halton5(uint32_t index);
    FT halton7(uint32_t index);
    FT halton11(uint32_t index);
}
